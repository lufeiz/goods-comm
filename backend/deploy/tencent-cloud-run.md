...
- `GOODS_COMM_RATE_LIMIT_MAX_REQUESTS=300`
- `GOODS_COMM_RATE_LIMIT_WINDOW_MS=60000`
- `GOODS_COMM_ROUTE_RATE_LIMIT_MAX_REQUESTS=120`
- `GOODS_COMM_ROUTE_RATE_LIMIT_WINDOW_MS=60000`
- `GOODS_COMM_USER_RATE_LIMIT_MAX_REQUESTS=80`
- `GOODS_COMM_USER_RATE_LIMIT_WINDOW_MS=60000`
- `GOODS_COMM_TRUSTED_PROXY_IPS=<cloudbase-or-load-balancer-egress-ip-or-cidr>`
